...
import { ChevronLeft, Home, Briefcase, Tag, Navigation, MapPin } from "lucide-react";
...
const emptyForm = {
  ...
  type: "house" as "house" | "office" | "other",
  label: "", instructions: "",
};
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-5">
        ...
        {profileData?.name && (
          <div className="flex items-start gap-3 bg-slate-50 rounded-2xl p-4 border border-border/40">
            <Checkbox
              ...
              onCheckedChange={v => handleUseAccount(!!v)}
              className="mt-0.5"
            />
            <div>
              <label htmlFor="use-account" className="text-sm font-semibold text-foreground cursor-pointer block">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Input value={form.area} onChange={e => setForm(f => ({ ...f, area: e.target.value }))} placeholder="e.g. Thane West, Maharashtra 400601" className="rounded-xl h-12 border-border/60 text-base" />
          </div>
